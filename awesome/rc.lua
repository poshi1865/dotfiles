...
awful.util.tagnames = { "1.term", "2.chrome", "3", "4", "5" }
...
-- Note by Naachiket Pant- I changed this to having a border in EVERY window (that is what I like). I don't know Lua and
-- removing the if-else was breaking awesomewm so I just did it this way
...
globalkeys = mytable.join(
    ...
    -- Screen brightness
    awful.key({ }, "XF86MonBrightnessUp", function () os.execute("brightnessctl set +1000") end,
              {description = "+10%", group = "hotkeys"}),
    awful.key({ }, "XF86MonBrightnessDown", function () os.execute("brightnessctl set 1000-") end,
              {description = "-10%", group = "hotkeys"}),

    -- ALSA volume control
	awful.key({}, "", function() os.execute("pactl set-sink-volume 0 +5%") end),
	awful.key({}, "", function() os.execute("pactl set-sink-volume 0 -5%") end),
