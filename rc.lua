...
globalkeys = mytable.join(
    ...
    -- Screen brightness
    awful.key({ }, "XF86MonBrightnessUp", function () os.execute("brightnessctl set +2000") end,
              {description = "+10%", group = "hotkeys"}),
    awful.key({ }, "XF86MonBrightnessDown", function () os.execute("brightnessctl set 2000-") end,
              {description = "-10%", group = "hotkeys"}),
